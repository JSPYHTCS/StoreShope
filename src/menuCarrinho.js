import { catalog, salvarLocalStorage, lerLocalStorage } from "./utilidades";
...
function desenharProdutoNoCarrinho(idProduto) {
  ...
  document
    ...
    .addEventListener("click", () => incremetarQuantidadeProduto(produto.id));
...
function incremetarQuantidadeProduto(idProduto) {
...
export function adicionarAoCarrinho(idProduto) {
  if (idProduto in idsProdutoCarrinhoComQuantidade) {
    incremetarQuantidadeProduto(idProduto);
    return;
  }
...
export function atualizarPrecoCarrinho() {
  ...
  for (const idProdutoNoCarrinho in idsProdutoCarrinhoComQuantidade) {
    precoTotalCarrinho +=
      catalog.find((p) => p.id === idProdutoNoCarrinho).preco *
